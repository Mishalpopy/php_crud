...
$sql = "SELECT * FROM cru_d WHERE id=$id";
...
if(isset($_POST['submit'])){
    ...
    $sql="UPDATE `cru_d` SET name='$name', email='$email', mobile='$mobile', password='$password' WHERE id=$id";
...
<html lang="en">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control"   placeholder="Enter Name" name="password" value=<?php echo $password;?>>
